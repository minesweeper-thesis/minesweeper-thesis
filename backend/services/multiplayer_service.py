...
type MultiplayerResult = RoundStart | RoundEnd | RoundAwaiting | RoundReadyCanceled | SessionOver | GameActionResult


class MultiplayerGameTransport(Protocol):
    async def receive(self) -> MultiplayerSessionAction: ...
